...
export const options = {
  ...
  plugins: {
    ...
    title: {
      display: true,
      text: 'Comparativa de general de materiales',
    },
  },
};

const labels = ['AG Grueso', 'AG Fino', 'Cemento', 'Agua',];
...
function Graph2() {
  ...
  const data = {
    ...
    datasets: [
      {
        label: '360f´c',
        data: [1038.6, 517.20, 557.06, 221.95,], // Your custom data
        borderColor: 'rgb(255, 99, 132)',
        backgroundColor: 'rgba(255, 99, 132, 0.5)',
      },
      {
        label: 'propio',
        data: [`${correcionHumedad2.toFixed(2)}`, `${correcionHumedad1.toFixed(2)}`, `${volCemento2.toFixed(2)}`, `${(correcionAbsorcion1 + correcionAbsorcion2).toFixed(2)}`,], // Your custom data
